...
class FsDottedLineCorner {
  ...
  FsDottedLineCorner.all(double radius)
...
class FsDottedLine extends StatefulWidget {
  ///
  /// Dotted line color
  final Color color;
  ...
  ///
  /// The corners of the dotted border. See [FsDottedLineCorner] for details
  final FsDottedLineCorner? corner;

  ///
  /// If [child] is set, [FsDottedLine] will serve as the dotted border of [child].
  /// At this time, [width] and [height] will no longer be valid.
  final Widget? child;

  ///
  /// [FsDottedLine] provides developers with the ability to create dashed lines. It also supports creating a dashed border for a [Widget]. Support for controlling the thickness, spacing, and corners of the dotted border.
  FsDottedLine({
    Key? key,
  ...
  @override
  _FsDottedLineState createState() => _FsDottedLineState();
}

class _FsDottedLineState extends State<FsDottedLine> {
  double? childWidth;
  double? childHeight;
